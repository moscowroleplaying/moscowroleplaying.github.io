...
class TbActiveForm extends CActiveForm
{
	...
	public function init()
	{
		...
		if ($this->inlineErrors)
			...
			$this->errorMessageCssClass = 'label label-danger';
	...
	protected function inputsList($checkbox, $model, $attribute, $data, $htmlOptions = array())
	{
		...
		if ($model->hasErrors($attribute))
		{
			if (isset($htmlOptions['class'])) {
				$class_temp = CHtml::$errorCss.' '.$htmlOptions['class'];
				$htmlOptions['class'] = $class_temp;
			}
			else
	...
	{
		if (!isset($htmlOptions['class']))
			$htmlOptions['class'] = 'alert alert-block alert-danger'; // Bootstrap error class as default
