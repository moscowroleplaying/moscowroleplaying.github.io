...
class XenForo_Search_DataHandler_ProfilePost extends XenForo_Search_DataHandler_Abstract
{
	...
	public function getTypeConstraintsFromInput(XenForo_Input $input)
	{
		...
		if ($searchComments = $input->filterSingle('search_comments', XenForo_Input::BOOLEAN))
		{
			$constraints['profile_post_comment'] = true;
		}
	...
	{
		if (!empty($constraints['profile_post_comment']))
		{
			$constraints['content'][] = 'profile_post_comment';
		}
