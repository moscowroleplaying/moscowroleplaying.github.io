...
<h3>Настройка параметров таблицы</h3>
<hr>

<form role="form" action="<? echo Yii::app()->baseUrl; ?>/site/settings/<? echo $id; ?>" method="POST">
	...
	<div class="pull-right">
		<a href="<? echo Yii::app()->baseUrl.'/site/addfield/'.$_GET['id']; ?>" class="btn btn-default"><i class="fa fa-plus-circle fa-fw"></i> Добавить параметр</a>	
		<button type="submit" class="btn btn-primary"><i class="fa fa-refresh fa-fw"></i> Сохранить параметры</button>	
	</div>
