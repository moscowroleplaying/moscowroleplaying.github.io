<? $this->pageTitle = 'Создание нового топ-листа (рейтинга) - '.Yii::app()->params->sitename; ?>
<h3>Создание нового топ-листа</h3>
<hr>
<p>
...
<form action="" method="POST" role="form">
	...
	<span>Таблица, по которой создается рейтинг:</span>
	<select name="Tops[table_id]" class="form-control">
		<?
			$options = '';
