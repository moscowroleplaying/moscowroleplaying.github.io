...
class XenForo_Model_User extends XenForo_Model
{
	...
	protected function _sendWelcomeMessage(array $user, array $option)
	{
		...
		array_pop($participantUsers); // we don't want to affect the new user in the following step (mark read, delete conversation)...
		$participantUsers[] = $starterUser; // ...we do want to affect the conversation starter though
